...
package ru.spliterash.vkVideoUnlocker.query;
...
import ru.spliterash.vkVideoUnlocker.response.RealSearchResponse;
 ...
 */
public class RealVideoSearchQuery extends AbstractQueryBuilder<RealVideoSearchQuery, RealSearchResponse> {
    /**
     ...
     */
    public RealVideoSearchQuery(VkApiClient client, UserActor actor, String q) {
        super(client, "video.search", RealSearchResponse.class);
     ...
     */
    protected RealVideoSearchQuery q(String value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery sort(SearchSort value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery hd(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery adult(Boolean value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery live(Boolean value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery searchOwn(Boolean value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery offset(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery longer(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery shorter(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery count(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery extended(Boolean value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery filters(String... value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public RealVideoSearchQuery filters(List<String> value) {
        return unsafeParam("filters", value);
    }

    @Override
    protected RealVideoSearchQuery getThis() {
        return this;
    }
